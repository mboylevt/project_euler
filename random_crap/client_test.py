...
# print(json.dumps(sw_api.get_single_material(material_id=27), indent=4, sort_keys=True))
# print(json.dumps(sw_api.get_single_model(model_id=7904178), indent=4, sort_keys=True))
...
# print(json.dumps(sw_api.get_orders(), indent=4, sort_keys=True))
print(json.dumps(sw_api.get_single_order(2506325), indent=4, sort_keys=True))
